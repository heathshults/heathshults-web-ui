import { r as registerInstance, e as createEvent, h, g as getElement } from './index-b5bbd2bc.js';
...
const HSCardButton = class {
  ...
  render() {
    ...
    return (h("button", { id: this.buttonId, class: this.cssClass, "data-bs-target": this.dataTarget, onClick: this.onclicker }, this.buttonText, h("slot", null)));
  }
