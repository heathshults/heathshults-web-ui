...
const HSProgress = class {
    constructor(hostRef) {
        ...
        this.size = '';
        this.onNotSame = index.createEvent(this, "change", 7);
    }
    onChangeBar(ev) {
    ...
    render() {
        ...
        return (index.h("div", { class: `hs-progress ${roundedClass} ${sizeClass}` }, index.h("slot", null)));
    }
    get element() { return index.getElement(this); }
};
HSProgress.style = componentsProgressCss;

exports.hs_progress = HSProgress;
