...
const HSProgressBar = class {
    ...
    render() {
        ...
        return (index.h("div", { role: "progressbar", "aria-valuenow": this.value, "aria-valuemin": this.min, "aria-valuemax": this.max, style: { width: `${percentage}%` }, class: `hs-progress__bar ${typeClass}` }, index.h("slot", null)));
    }
...
exports.hs_progress_bar = HSProgressBar;
