...
var _typeof2 = _interopRequireDefault(require("@babel/runtime/helpers/typeof")); //! moment.js
//! version : 2.29.1
...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : (0, _typeof2.default)(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : global.moment = factory();
})(void 0, function () {
  'use strict';
    ...
    return extend(function () {
      ...
      if (firstTime) {
        ...
        for (i = 0; i < arguments.length; i++) {
          ...
          if ((0, _typeof2.default)(arguments[i]) === 'object') {
            arg += '\n[' + i + '] ';
  ...
  function stringSet(units, value) {
    if ((0, _typeof2.default)(units) === 'object') {
  ...
  function createDuration(input, key) {
    ...
    if (isDuration(input)) {
      ...
      duration = {};
    } else if ((0, _typeof2.default)(duration) === 'object' && ('from' in duration || 'to' in duration)) {
  ...
  function localeEras(m, format) {
    ...
    for (i = 0, l = eras.length; i < l; ++i) {
      switch ((0, _typeof2.default)(eras[i].since)) {
        case 'string':
          // truncate time
      ...
      switch ((0, _typeof2.default)(eras[i].until)) {
        case 'undefined':
  ...
  function humanize(argWithSuffix, argThresholds) {
    ...
    if ((0, _typeof2.default)(argWithSuffix) === 'object') {
    ...
    if ((0, _typeof2.default)(argThresholds) === 'object') {
