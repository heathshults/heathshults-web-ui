...
((w,d,x,n,h,c,r)=>{((s)=>{s&&(r=s.getAttribute('data-resources-url'))})(d.querySelector("script[data-namespace='framekit-highlight-code']"));
/**
 * SSR Attribute Names
 */
...
const defineMember = (plt, property, elm, instance, memberName, hostSnapshot, perf, hostAttributes, hostAttrValue) => {
  ...
  definePropertyValue(instance, memberName, elm) : property.method && 
  // @Method()
...
})(window,document,{},"FramekitHighlightCode","hydrated",[["fk-highlight-code","fk-highlight-code",1,[["anchor",1,0,1,2],["anchorZoom",1,0,"anchor-zoom",2],["el",64],["findNextAnchor",32],["hideAnchor",1,0,"hide-anchor",4],["highlightLines",1,0,"highlight-lines",2],["language",1,0,1,2],["load",32],["src",1,0,1,2],["zoomCode",32]],1,[["document:prismLanguageLoaded","languageLoaded"]]]]);